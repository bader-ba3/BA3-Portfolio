        ...
        className=" flex flex-col relative items-center justify-center  w-full h-[100vh]">
            ...
            <div
              ...
              <motion.div
                    ...
                    className="text-[40px] font-medium text-center my-[55px] text-gray-200"
                >
                    {encyptionText("Performance")}
                    <span className="text-transparent py-100 bg-clip-text bg-gradient-to-r from-purple-500 to-cyan-500">
                        {" "}
                        {encyptionText("&")}{" "}
                    </span>
                    {encyptionText("Security")}
                </motion.div>
                <div className="Welcome-box px-[15px] py-[4px] z-[-1] brder my-[20px] border-[#7042f88b] opacity-[0.9]">
